...
//			}
	...
	public List<VtArtefacto> findArtefactosBySpring(VtSprint vtSprint) throws Exception{
		...
		List<VtArtefacto> losArtefactos = new ArrayList<VtArtefacto>();

		try {
			Object[] variables = {"vtSprint.spriCodigo", false, vtSprint.getSpriCodigo(),"="};
	...
	public List<VtArtefacto> findArtefactosVaciosPorBacklogYDesarrollador(Long backlogId) {
		return vtArtefactoDAO.findArtefactosVaciosPorBacklogYDesarrollador(backlogId);
	}
